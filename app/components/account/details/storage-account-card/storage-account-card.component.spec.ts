...
const accountNoStorage = new BatchAccount({ id: "acc-1", location: "westus", properties: {} } as any);
const accountWithStorage = new BatchAccount({
    id: "acc-1",
    location: "westus",
    properties: {
...
const accountWithInvalidStorage = new BatchAccount({
    id: "acc-1",
    location: "westus",
    properties: {
