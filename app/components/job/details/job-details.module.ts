...
import { TaskGraphsModule } from "app/components/task/graphs";
...
const modules = [
    BaseModule, FileBrowseModule, FileDetailsModule, TaskBrowseModule, JobHookTaskModule, TaskGraphsModule,
];
