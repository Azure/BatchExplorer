...
const baseConfig = {
    ...
    resolve: {
        ...
        alias: {
            ...
            react: path.resolve("../node_modules/react", __dirname),
            "react-dom": path.resolve('../node_modules/react-dom', __dirname),
            // Since we are patching the core-util module' isNode variable,
            // we need to make sure that the patched version is used by all
            "@azure/core-util": path.resolve('./node_modules/@azure/core-util', __dirname),
        },
    },
