...
export class ClientTranslationsLoaderService extends TranslationsLoaderService {
    ...
    private async _loadProductionTranslations() {
        const englishTranslationFile = path.join(ClientConstants.resourcesFolder, "./resources/i18n/json/resources.en.json");
    ...
    private async _loadLocaleTranslations() {
        ...
        const localeTranslationFile = path.join(ClientConstants.resourcesFolder, `./resources/i18n/json/resources.${locale}.json`);
