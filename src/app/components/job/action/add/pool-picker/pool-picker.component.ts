...
import {
    PoolOsService, PoolService, RenderingContainerImageService,
    VmSizeService,
} from "app/services";
...
export class PoolPickerComponent implements ControlValueAccessor, OnChanges, OnDestroy {
    ...
    private _filterPool(pool: Pool, filters: PoolFilters, inputs: Inputs | null,
        ...
        if (inputs && inputs.app && inputs.renderEngine && inputs.imageReferenceId) {
